...
public class TestMover {
    ...
    public void testValidPlayerMove() {
        ...
        Assert.assertEquals(Player.OPPONENT, game.getTurn());
    }

    @Test
    public void testValidOpponentMove() {

        game.setTurn(Player.OPPONENT);
        mover.move(0);
        ...
        Assert.assertEquals(Player.PLAYER, game.getTurn());
    }
    ...
    @Test
    public void testPlayerSweepNoOpposing() {
    ...
    @Test
    public void testOpponentSweepNoOpposing() {
